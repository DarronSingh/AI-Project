...
public class Simulation extends JPanel {
	...
	public static void runJarFile(String args[]) throws IOException {
		if (args.length == 0) {
			...
			System.out.println(" ------------------------------------");
			System.out.println("|Running Group 13 Project.           |");
			System.out.println("|Jasindan Rasalingam - 100584595     |");
			System.out.println("|Darron Singh - 100584624            |");
			System.out.println("|Ashwin Kamalakannan - 100584423     |");
			System.out.println(" ------------------------------------");
			System.out.println("\n");
		}
	}
